...
O pacote \texttt{magrittr} tem dois objetivos: diminuir o tempo de desenvolvimento e melhorar a legibilidade e a manutenção do código.
...
O \texttt{magrittr} também fornece três operadores de tubos relacionados. Eles não são tão comuns quanto, \texttt{\%\textgreater{}\%} mas se tornam úteis em casos especiais.
...
\chapter{\texorpdfstring{Função \texttt{spread()}}{Função spread()}}\label{funuxe7uxe3o-spread}}
...
##  1 0.284 0.966  0.0193 0.373 0.480   0.811  0.755  0.871 
##  2 0.418 0.984  0.0615 0.860 0.493   0.654  0.918  0.627 
##  3 0.971 0.0352 0.747  0.380 0.713   0.312  0.733  0.0569
##  4 0.991 0.440  0.839  0.897 0.339   0.927  0.852  0.762 
##  5 0.329 0.731  0.995  0.137 0.304   0.0157 0.136  0.0553
##  6 0.413 0.0280 0.427  0.468 0.452   0.541  0.0122 0.784 
##  7 0.692 0.998  0.815  0.251 0.430   0.0650 0.978  0.290 
##  8 0.167 0.611  0.198  0.614 0.00415 0.167  0.529  0.125 
##  9 0.466 0.521  0.833  0.517 0.638   0.523  0.516  0.0185
## 10 0.811 0.970  0.845  0.724 0.0711  0.758  0.218  0.0395
\end{verbatim}
...
##  1 0.284 0.811  0.871 
##  2 0.418 0.654  0.627 
##  3 0.971 0.312  0.0569
##  4 0.991 0.927  0.762 
##  5 0.329 0.0157 0.0553
##  6 0.413 0.541  0.784 
##  7 0.692 0.0650 0.290 
##  8 0.167 0.167  0.125 
##  9 0.466 0.523  0.0185
## 10 0.811 0.758  0.0395
\end{verbatim}
