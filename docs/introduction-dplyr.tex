...
\begin{verbatim}
##  num [1:50, 1:2] -1.1119 -0.3139 0.0372 0.6148 -1.372 ...
\end{verbatim}
...
Vamos criar um \texttt{tibble} no formato \emph{wide} e transformá-lo em um dado \emph{tidy}. Utilizando o conjunto de dados \texttt{storms} do pacote \texttt{EDAWR}, que descreve a velocidades máximas do vento para seis furacões no Atlântico.
...
##  1 0.178 0.141  0.905 0.173 0.0478 0.688   0.148  0.448  
##  2 0.951 0.896  0.245 0.349 0.927  0.864   0.452  0.470  
##  3 0.693 0.132  0.247 0.296 0.584  0.518   0.468  0.136  
##  4 0.216 0.581  0.737 0.609 0.0464 0.336   0.821  0.533  
##  5 0.723 0.829  0.424 0.554 0.181  0.00588 0.524  0.252  
##  6 0.489 0.415  0.420 0.178 0.572  0.536   0.0216 0.437  
##  7 0.374 0.237  0.211 0.808 0.524  0.893   0.799  0.967  
##  8 0.829 0.0971 0.951 0.916 0.307  0.424   0.608  0.00597
##  9 0.632 0.0916 0.565 0.506 0.544  0.190   0.138  0.837  
## 10 0.502 0.738  0.328 0.806 0.932  0.865   0.172  0.0590
\end{verbatim}
...
##  3 0.693 0.518   0.136  
##  4 0.216 0.336   0.533  
##  5 0.723 0.00588 0.252  
##  6 0.489 0.536   0.437  
##  7 0.374 0.893   0.967  
##  8 0.829 0.424   0.00597
##  9 0.632 0.190   0.837  
## 10 0.502 0.865   0.0590
\end{verbatim}
