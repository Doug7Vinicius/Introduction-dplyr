...
```{r figure5, echo=FALSE, fig.align='center', out.width="75%"}
...
Costuma-se dizer que 80% da análise de dados é gasta no processo de limpeza e preparação os dados (Dasu e Johnson 2003).

--

### `tidyr`

```{r figure0, echo=FALSE, fig.align='center', out.width="30%"}
