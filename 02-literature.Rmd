...
Vamos criar um `tibble` no formato *wide* e transformá-lo em um dado *tidy*. Utilizando o conjunto de dados `storms` do pacote `EDAWR`, que descreve a velocidades máximas do vento para seis furacões no Atlântico.
